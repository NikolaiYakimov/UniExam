...
{{--<head>--}}
{{--    <meta charset="UTF-8">--}}
{{--    <title>Преподавател и изпити</title>--}}
...
{{--        <h1 class="mb-0"><i class="fas fa-chalkboard-teacher me-2"></i>{{ $teacher->first_name }} {{ $teacher->second_name }} {{ $teacher->last_name }}</h1>--}}
{{--        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createExamModal">--}}
{{--            <i class="fas fa-plus"></i> Нов изпит--}}
{{--        </button>--}}
{{--    </div>--}}
{{--</div>--}}
...
{{--        <h4 class="mb-3">Информация за преподавателя</h4>--}}
{{--        <div class="icon-text">--}}
{{--            <i class="fas fa-envelope"></i> <span><strong>Имейл:</strong> {{ $teacher->email }}</span>--}}
{{--        </div>--}}
{{--        <div class="icon-text">--}}
{{--            <i class="fas fa-phone-alt"></i> <span><strong>Телефон:</strong> {{ $teacher->phone }}</span>--}}
{{--        </div>--}}
{{--        <div class="icon-text">--}}
{{--            <i class="fas fa-building"></i> <span><strong>Катедра:</strong> {{ $teacher->department }}</span>--}}
{{--        </div>--}}
{{--    </div>--}}

{{--    <div class="mb-3 label-section">--}}
{{--        <i class="fas fa-file-alt me-1"></i> Водени изпити--}}
{{--    </div>--}}

{{--    <hr>--}}

{{--    @if ($teacher->exams->isEmpty())--}}
{{--        <div class="alert alert-info text-center">Няма налични изпити за този преподавател.</div>--}}
{{--    @else--}}
{{--        <div class="row">--}}
...
{{--                            <p><i class="fas fa-calendar-alt"></i> <strong>Дата:</strong> {{ \Carbon\Carbon::parse($exam->date)->format('d.m.Y H:i') }}</p>--}}
{{--                            <p><i class="fas fa-map-marker-alt"></i> <strong>Място:</strong> {{ $exam->location ?? 'Няма информация' }}</p>--}}
{{--                            <p><i class="fas fa-users"></i> <strong>Записани студенти:</strong> {{ $exam->students_count ?? 0 }}</p>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            @endforeach--}}
...
{{-- Optional: Модал за нов изпит (можеш да го активираш при нужда) --}}
...
<body class="bg-gradient-to-br from-indigo-50 to-blue-100 min-h-screen" x-data="{ showModal: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 mb-12 border border-white/10">
        ...
        <button @click="showModal = true"
                class="fixed bottom-8 right-8 w-14 h-14 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white shadow-xl flex items-center justify-center transition-all duration-300 hover:rotate-90">
            ...
            <button type="submit"
                ...
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1m0-9V4m0 0h1a2 2 0 012 2v1"/>
                </svg>
            </button>
        </form>
    <style>
