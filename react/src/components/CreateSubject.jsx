...
//         try {
//             const response = await api.get('/subjects/create'); // Трябва да създадете този endpoint
...
//                 : formData.specialties.filter(id => id !== value);
//
...
//             setAlert({ type: 'success', message: 'Дисциплината е създадена успешно!' });
...
//                             </div>
//                             <a href="/subjects" className="inline-flex items-center gap-1 px-4 py-3 bg-gray-500 text-white rounded-lg shadow hover:bg-gray-700 transition-colors">
...
//                                                 />
//                                                 <label htmlFor={`specialty_${specialty.id}`} className="ml-2 text-sm text-gray-700">
//                                                     {specialty.name}
//                                                 </label>
//                                             </div>
//                                         ))}
...
//     const fetchSpecialties = async () => {
//         try {
//             // const response = await api.get('/subject/create');
//             // setSpecialties(response.data.specialties);
//             const response = await api.get('/subjects/create'); // Трябва да създадете този endpoint
//             setSpecialties(response.data.specialties);
//         } catch (error) {
...
//         price: 40.00,
//         specialties: [],
//         teachers: [] // Добавяме преподаватели
//     });
//     const [specialties, setSpecialties] = useState([]);
//     const [availableTeachers, setAvailableTeachers] = useState([]); // Добавяме налични преподаватели
//     const [alert, setAlert] = useState({ type: '', message: '' });
//     const [loading, setLoading] = useState(false);
//
//     useEffect(() => {
...
//     //             return Object.values(teachersBySpecialty).some(group =>
...
//         const selectedSpecialtyIds = formData.specialties.map(id => parseInt(id));
//
//         // Създаваме обект с преподаватели, групирани по специалности
...
//                                                                 className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
//                                                             />
//                                                             <label htmlFor={`teacher_${teacher.id}`} className="ml-2 text-sm text-gray-700">
