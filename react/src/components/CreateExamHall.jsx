...
//             setAlert({ type: 'success', message: 'Залата е създадена успешно!' });
//             setTimeout(() => navigate('/exam-halls'), 1500);
//         } catch (error) {
//             console.error('Грешка при създаване на зала:', error);
//             if (error.response?.data?.message) {
//                 setAlert({ type: 'error', message: error.response.data.message });
//             } else {
//                 setAlert({ type: 'error', message: 'Грешка при създаване на зала' });
//             }
//         } finally {
//             setLoading(false);
//         }
...
//                             <div>
//                                 <h1 className="text-2xl font-bold text-gray-800">Добавяне на нова изпитна зала</h1>
//                                 <p className="text-sm text-gray-500 mt-1">Попълнете формата за добавяне на нова зала</p>
//                             </div>
//                             <Link
//                                 to="/exam-halls"
