...
export default function TeacherProfile() {
    ...
    useEffect(() => {
        if (user) {
            ...
            // Зареждане на допълнителни данни за преподавателя
            fetchTeacherData();
        }
    }, [user]);
    ...
    const fetchTeacherData = async () => {
        try {
            ...
            showAlert('error', 'Възникна грешка при зареждане на данните.');
        }
    };
    ...
    const handlePersonalInfoSubmit = async (e) => {
        ...
        try {
            ...
            showAlert('success', 'Профилът е обновен успешно.');
            setIsEditing(false);
            // Обновяване на потребителските данни
            fetchTeacherData();
        } catch (error) {
            console.error('Грешка при обновяване на профила:', error);
            showAlert('error', error.response?.data?.message || 'Възникна грешка при обновяване на профила.');
        }
    };
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            ...
            showAlert('success', 'Паролата е сменена успешно.');
            setPasswordData({
                current_password: '',
                password: '',
                password_confirmation: ''
            ...
            showAlert('error', error.response?.data?.message || 'Възникна грешка при смяна на паролата.');
        }
    };

    if (isLoading || !user || !teacherData) {
        return <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 flex items-center justify-center">Зареждане...</div>;
    }
                ...
                <main className="flex-1 p-4 lg:p-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="profile-card bg-white border border-gray-100 rounded-2xl p-6 lg:p-8 shadow-sm">
                            ...
                            <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                <div className="flex-1">
                                    <form onSubmit={handlePersonalInfoSubmit} className="info-grid">
                                        <div>
                        ...
                        <div className="profile-card bg-white border border-gray-100 rounded-2xl p-6 lg:p-8 shadow-sm">
                            <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
                                <h2 className="text-xl font-semibold text-gray-800 section-title">
                                    <i className="fas fa-briefcase text-indigo-500"></i> Професионална информация
                                </h2>
                            ...
                            <div className="info-grid">
                                ...
                                <div>
                                    ...
                                    <div className="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 flex items-center">
                                        ...
                                        {teacherData.teacher?.subjects_count || 0} предмета
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 flex items-center">
                                        ...
                                        {teacherData.teacher?.exams_count || 0} изпита
                                    </div>
                                </div>
                            </div>
                        </div>
