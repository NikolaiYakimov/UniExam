...
export default function Sidebar({ user }) {
    ...
    return (
        <aside id="sidebar" className="sticky top-0 h-screen w-80 bg-white p-6 border-r border-gray-200 overflow-y-auto">
            <div className="flex flex-col h-full">
                <h2 className="text-xl font-semibold text-gray-900 mb-6 pb-4 border-b border-gray-100 flex items-center">
                    ...
                    {user.role === 'student' ? 'Студентски профил' : 'Преподавателски профил'}
                </h2>
                        ...
                        <div>
                            ...
                            {user.role === 'student' ? (
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    ...
                                    {user.teacher?.exams_count || 0} активни изпита
                                </p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="space-y-3.5 mt-4">
                        {user.role === 'student' ? (
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-800">{user.teacher?.faculty}</p>
                            </div>
                        ) : null}
