        ...
        <div className="login-page-wrapper">
            ...
            <div className="login-card">
                <div className="login-header">
                    ...
                    <h1>Вход в студентския портал</h1>
                    <p className="subtitle">Технически Университет - София</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="login-form">
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-wrapper">
                            ...
                            <input
                                ...
                                className={errors.username || errors.general ? 'form-input error' : 'form-input'}
                                required
                                autoFocus
                            />
                        </div>
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-wrapper">
                            ...
                            <input
                                ...
                                className={errors.password || errors.general ? 'form-input error' : 'form-input'}
                                required
                            />
                            <button
                                type="button"
                    ...
                    <button
                        ...
                        disabled={isSubmitting}
                    >
                        {isSubmitting ? <span className="loader"></span> : 'Вход в системата'}
                    </button>
                </form>

                <div className="login-footer">
                    <p>&copy; {new Date().getFullYear()} UniExam • ТУ-София</p>
                </div>
            </div>
        </div>
    );
